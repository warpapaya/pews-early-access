...
def contact_info() -> dict:
    ...
    return {
        ...
        "email": field(True, True, "Work email"),
...
QUESTIONS = [
    ...
    single(
        "current_system",
        "How are you managing that work now?",
        [
            "Planning Center",
            "Another church management platform",
            "Spreadsheets, forms, and shared documents",
    ...
    single(
        "beta_timing",
        "When would you realistically evaluate an early beta?",
